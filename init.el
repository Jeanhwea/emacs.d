...
(custom-set-variables
 ...
 ;; If there is more than one, they won't work right.
  ...
  '(package-selected-packages
     (quote
       (fill-column-indicator emmet-mode tide markdown-mode js-comint expand-region nyan-mode company exec-path-from-shell helm evil browse-at-remote yasnippet smex magit color-theme-sanityinc-solarized ag))))
(custom-set-faces
