...
(custom-set-variables
 ...
 '(org-agenda-files '("f:/Code/avic/worknotes/vserver.org"))
  '(package-selected-packages
     '(ace-jump-mode adoc-mode ag auctex browse-at-remote browse-kill-ring color-theme-sanityinc-solarized color-theme-sanityinc-tomorrow company company-fuzzy counsel csharp-mode csv-mode cuda-mode dashboard docker dockerfile-mode edit-indirect editorconfig elfeed elm-mode elpy emmet-mode engine-mode evil evil-leader exec-path-from-shell expand-region figlet fill-column-indicator flycheck flyspell-correct ggtags graphviz-dot-mode groovy-mode haskell-mode htmlize js-comint keyfreq leetcode lsp-java lsp-mode lsp-ui lua-mode magit markdown-mode monokai-theme multiple-cursors nyan-mode org-bullets pangu-spacing posframe projectile protobuf-mode pyim rainbow-delimiters restclient rg sicp smex spacemacs-theme sql-indent sqlformat string-inflection swiper tide verb web-mode yaml-mode zenburn-theme yasnippet)))
(custom-set-faces
